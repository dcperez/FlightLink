...
void setup()
{
  ...
  printArray(Serial.list()); //Shows your connected serial ports
...
void ShowHeading()
{
  ...
  noStroke();
  rect(20, 470, 440, 50);
  int Heading1=round(Heading);
  textAlign(CORNER);
  textSize(35);
  fill(255);
  text("Heading:  "+Heading1+" Deg", 80, 477, 500, 60);
  textSize(40);
  fill(25,25,150);
  text("Daniel Perez", -350, 477, 500, 60);
}
void Compass()
{
  translate(2*1920/3, 0);
